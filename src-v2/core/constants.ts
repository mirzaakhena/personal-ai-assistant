...
// Importance auto-promotion/demotion thresholds
export const MEMORY_PROMOTION_ACCESS_THRESHOLD = 5;
export const MEMORY_DEMOTION_INACTIVE_DAYS = 30;

// Hybrid search weights
// When embeddings enabled: vector 0.5 + keyword 0.3 + recency 0.2
// When embeddings disabled: keyword 0.7 + recency 0.3
export const MEMORY_VECTOR_WEIGHT = 0.5;
export const MEMORY_KEYWORD_WEIGHT = 0.3;
export const MEMORY_RECENCY_WEIGHT = 0.2;

// Model
export const DEFAULT_MODEL = process.env.CLAUDE_MODEL ?? 'opus';
export const FALLBACK_MODEL = process.env.CLAUDE_FALLBACK_MODEL ?? 'sonnet';
